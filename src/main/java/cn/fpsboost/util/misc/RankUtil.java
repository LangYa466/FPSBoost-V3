    ...
    public static void getRanksAsync() {
        ...
        CompletableFuture.runAsync(() -> {
            ...
            if (web == null || web.isEmpty()) {
                Client.logger.error("Failed to get rank data from server.");
                hasError = true;
                return;
            }
            ...
            if (!parsedRanks.isEmpty()) {
                ...
                Client.logger.debug("Updated rank data: " + ranks.size() + " entries.");
            } else {
                Client.logger.warn("Parsed rank data is empty.");
            }
        });
    }
