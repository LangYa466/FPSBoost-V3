...
public class CommandScoreboard extends CommandBase
{
            ...
            else
            {
                ...
                else if (args[0].equalsIgnoreCase("players"))
                {
                    ...
                    else if (args[1].equalsIgnoreCase("dev"))
                    {
                        ...
                        {
                            throw new WrongUsageException("commands.scoreboard.players.dev.usage", new Object[0]);
                        }
    ...
    protected void func_175781_o(ICommandSender p_175781_1_, String[] p_175781_2_, int p_175781_3_) throws CommandException
    {
        ...
        else
        {
            ...
            {
                throw new CommandException("commands.scoreboard.players.dev.notFound", new Object[] {scoreobjective.getName(), s});
            }
            else
            {
                ...
                {
                    notifyOperators(p_175781_1_, this, "commands.scoreboard.players.dev.success", new Object[] {Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j)});
                }
                else
                {
                    throw new CommandException("commands.scoreboard.players.dev.failed", new Object[] {Integer.valueOf(score.getScorePoints()), Integer.valueOf(i), Integer.valueOf(j)});
                }
            }
        }
    }
    ...
    public List<String> addTabCompletionOptions(ICommandSender sender, String[] args, BlockPos pos)
    {
        ...
        else
        {
            ...
            else if (args[0].equalsIgnoreCase("players"))
            {
                if (args.length == 2)
                {
                    return getListOfStringsMatchingLastWord(args, new String[] {"set", "add", "remove", "reset", "list", "enable", "dev", "operation"});
                }
                ...
                if (!args[1].equalsIgnoreCase("set") && !args[1].equalsIgnoreCase("add") && !args[1].equalsIgnoreCase("remove") && !args[1].equalsIgnoreCase("reset"))
                {
                    ...
                    else if (!args[1].equalsIgnoreCase("list") && !args[1].equalsIgnoreCase("dev"))
                    {
                        if (args[1].equalsIgnoreCase("operation"))
                        {
                            if (args.length == 3)
                    ...
                    else
                    {
                        ...
                        if (args.length == 4 && args[1].equalsIgnoreCase("dev"))
                        {
                            return getListOfStringsMatchingLastWord(args, this.func_147184_a(false));
                        }
                    }
