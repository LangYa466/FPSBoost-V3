...
public class IconUtil {
    ...
    public static final ResourceLocation icon = new ResourceLocation("fpsboost/icons/icon_32x32.png");
    public static final ResourceLocation iconBig = new ResourceLocation("fpsboost/icons/icon_150x150.png");

    public static ByteBuffer[] getFavicon() {
        try {
            return new ByteBuffer[]{
                    readImageToBuffer(IconUtil.class.getResourceAsStream("/assets/minecraft/fpsboost/icons/icon_16x16.png")),
                    readImageToBuffer(IconUtil.class.getResourceAsStream("/assets/minecraft/fpsboost/icons/icon_32x32.png"))
            };
        } catch (IOException e) {
