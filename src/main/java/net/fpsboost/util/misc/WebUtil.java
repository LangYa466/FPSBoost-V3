...
public class WebUtil {
    ...
    private static String getRequest(String url, boolean noCache) {
        try {
            ...
            Client.logger.error("Error during HTTP request: {}", e.getMessage());
            return null;
        }
    }
    ...
    public static BufferedImage fetchImage(String imageUrl) throws IOException {
        ...
        try {
            ...
            Client.logger.error("Failed to fetch image or timeout occurred: {}", e.getMessage());
            return null;
        }
    }
    ...
    private static ResourceLocation bindTexture(String path, String name, boolean isLocal) {
        ...
        try {
            ...
            Client.logger.error("Failed to load texture: {}", e.getMessage());
        }
        return res;
    }
}
